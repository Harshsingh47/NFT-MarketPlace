...
contract NFT is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    function approveMarketPlace(address _marketplaceContractAddress) public {
        setApprovalForAll(_marketplaceContractAddress, true); //grants transaction permission to marketplace
    }
